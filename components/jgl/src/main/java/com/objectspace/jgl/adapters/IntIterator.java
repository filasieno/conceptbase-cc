...
/**
 * A IntIterator is a random access iterator that allows you to iterate through
...
public final class IntIterator implements RandomAccessIterator, Serializable
   ...
   * array of ints.
   * @param vector My associated int[].
   ...
   * @param vector My associated IntArray.
   * @param index My associated index.
   */
  ...
  public boolean less( RandomAccessIterator iterator )
    {
    return index < ( (IntIterator)iterator ).index;
    }
