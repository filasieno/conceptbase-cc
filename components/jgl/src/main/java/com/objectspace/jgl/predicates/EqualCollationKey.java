...
/**
 * EqualCollationKey is a binary predicate that returns true
 * if the first operand as a string is equal to the
...
public final class EqualCollationKey implements BinaryPredicate
  {
  Collator collator;
   ...
   */
  public EqualCollationKey()
    {
    collator = Collator.getInstance();
    }

  /**
   * Construct a EqualCollationKey function object that uses the given collator
   ...
   */
  public EqualCollationKey( Collator collator )
    {
   ...
   * @return true if the sort key of the first operand is equal to that of the second.
   */
  ...
  static final long serialVersionUID = 2403506379613544889L;
  }
