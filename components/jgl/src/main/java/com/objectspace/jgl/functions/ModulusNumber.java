...
public final class ModulusNumber implements BinaryFunction
   ...
   */
  public ModulusNumber( Class discriminator, int rounding )
    {
    if ( !Number.class.isAssignableFrom( discriminator ) )
      throw new IllegalArgumentException( "discriminator must be an instance of java.lang.Number" );
    mode = discriminator;
  ...
  public Object execute( Object first, Object second )
    {
    return NumberHelper.modulus( (Number)first, (Number)second, mode, rounding );
    }
  
  static final long serialVersionUID = 2367941686735191050L;
  }
