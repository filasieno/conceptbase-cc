...
/**
 * A CharIterator is a random access iterator that allows you to iterate through
 * the contents of a CharBuffer.
 * <p>
...
public final class CharIterator implements RandomAccessIterator, Serializable
   ...
   */
  public static CharIterator begin( char[] array )
    {
    return new CharIterator( array, 0 );
    }
   ...
   */
  public static CharIterator end( char[] array )
    {
    return new CharIterator( array, array.length );
    }
   ...
   */
  public CharIterator( CharIterator iterator )
    {
   ...
   * array of chars.
   * @param vector My associated char[].
   * @param index My associated index.
   */
  public CharIterator( char[] vector, int index )
    {
    this( new CharArray( vector ), index );
    }

  /**
   * Construct myself to be positioned at a particular index of a specific CharArray.
   * @param vector My associated CharArray.
   * @param index My associated index.
   */
  public CharIterator( CharArray vector, int index )
    {
    buffer = vector.array;
    original = vector;
    this.index = index;
   ...
   * @param vector My associated CharBuffer.
   * @param index My associated index.
   */
  public CharIterator( CharBuffer vector, int index )
    {
  ...
  public boolean equals( Object object )
    {
    return object instanceof CharIterator && equals( (CharIterator)object );
    }
   ...
   */
  public boolean equals( CharIterator iterator )
    {
  ...
  public boolean less( RandomAccessIterator iterator )
    {
    return index < ( (CharIterator)iterator ).index;
    }
  ...
  public Object nextElement()
    ...
    try
      ...
      {
      throw new java.util.NoSuchElementException( "CharIterator" );
      }
    }
  ...
  public Object get( int offset )
    {
    return new Character( buffer[ index + offset ] );
    }
  ...
  public void put( int offset, Object object )
    {
    put( offset, CharBuffer.asChar( object ) );
    }
  public void put( int offset, char object )
    {
  ...
  public int distance( ForwardIterator iterator )
    ...
    return ( (CharIterator)iterator ).index - index;
    }
  ...
  public boolean isCompatibleWith( InputIterator iterator )
    {
    return iterator instanceof CharIterator && buffer == ( (CharIterator)iterator ).buffer;
    }
