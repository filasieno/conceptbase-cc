...
/**
 * NotEqualNumber is a binary predicate that assumes that both of its operands are
 * instances of Number and returns false if the first operand is the same as the second operand.
 * <p>
...
public class NotEqualNumber implements BinaryPredicate
  {
  private Class mode;
   ...
   */
  public NotEqualNumber( Class discriminator )
    {
  ...
  static final long serialVersionUID = 8896965969409937853L;
  }
