...
/**
 * The SetOperations class contains generic set operation algorithms.
 * <p>
 * @see com.objectspace.jgl.examples.SetOperationsExamples
 * @version 3.1.0
...
public final class SetOperations
  ...
  public static boolean includes( InputIterator first1, InputIterator last1, InputIterator first2, InputIterator last2, BinaryPredicate comparator )
    ...
    if ( !first2.isCompatibleWith( last2 ) )
      throw new IllegalArgumentException( "iterators not compatible" );
