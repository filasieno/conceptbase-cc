...
/**
 * This class extends java.awt.geom.Dimension2D and provides built-in string-to-Dimension2D and Dimension2D-to-string
 * conversions suitable for Grappa.
 *
 * @version $Id: d40cc918e99928c268f8eec08a5337cf2d19598c $
...
public class GrappaSize extends java.awt.geom.Dimension2D
{
    ...
    /**
     * Constructs and initializes a <code>GrappaSize</code> with coordinates (0,&nbsp;0).
     */
    public GrappaSize()
    {
    }
    ...
    /**
     * Constructs and initializes a <code>GrappaSize</code> with the specified coordinates.
     *
     * @param width,&nbsp;height the coordinates to which to set the newly constructed <code>GrappaSize</code>
     */
    ...
    /**
     * Constructs and initializes a <code>GrappaSize</code> with the coordinates derived from the specified String
     * representation. The String format should be: "<I>width</I>,<I>height</I>"
     *
     * @param dimenString String representing the dimensions to which to set the newly constructed
    ...
    public GrappaSize(String dimenString)
    {
        ...
        try {
            ...
            throw new IllegalArgumentException("coordinate string (" + dimenString + ") has a bad number format ("
                + nfe.getMessage() + ")");
        }
        if (coords == null || coords.length != 2) {
            throw new IllegalArgumentException("coordinate string (" + dimenString
                + ") does not contain 2 valid coordinates");
        }
        this.width = coords[0];
