...
/**
 * This class provides a flexible, parameterized polygonal shape builder. The guts of a GrappaShape is a GeneralPath
 * object.
 *
 * @version $Id: c97ab4372c13821cfabfd94cafed591cf472f8ef $
...
public class GrappaShape implements GrappaConstants, Cloneable, Shape
{
    ...
    /**
     * Constructs a new <code>GrappaShape</code> object. The winding rule for this path is defaulted (from
     * Grappa.windingRule).
     *
     ...
     * @param extra used only with the <I>record</I> shape at present, it provides a string of tuples giving interior
     *            partition information.
     */
    public GrappaShape(int type, double x, double y, double width, double height, int sidesArg, int peripheriesArg,
        double distortionArg, double skewArg, double orientationArg, boolean roundedArg, boolean diagonalsArg,
        Object extra)
    {
        ...
        double sectorAngle = 2.0 * Math.PI / sides;
            ...
            if (j > 0) {
                if (j == 1) {
                    ...
                    for (i = 0; i < sides; i++) {
                        ...
                        /*
                         * find the distance along the bisector to the intersection of the next periphery
                         */
