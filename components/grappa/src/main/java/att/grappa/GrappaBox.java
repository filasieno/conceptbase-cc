 ...
 *
 * @version $Id: f0096890defc10315b5ec9e7c62a611e53d291f5 $
...
public class GrappaBox extends java.awt.geom.Rectangle2D.Double
{
    ...
    /**
     * Constructs and initializes a <code>GrappaBox</code> with upper-left coordinates (0,&nbsp;0) and zero width and
     * height.
     */
    public GrappaBox()
    {
    ...
    /**
     * Constructs and initializes a <code>GrappaBox</code> with the specified coordinates.
     *
    ...
    /**
     * Constructs and initializes a <code>GrappaBox</code> with the coordinates derived from the specified String
     * representation. When the <I>dimensioned</I> parameter is true, then the String format should be:
     * "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>" otherwise it should be:
     * "<I>x1-coord</I>,<I>y1-coord</I>,<I>x2-coord</I>,<I>y2-coord</I>"
     *
     * @param coordString String representing the coordinates to which to set the newly constructed
     *            <code>GrappaBox</code>
    ...
    public GrappaBox(String coordString, boolean dimensioned)
    {
        ...
        try {
            ...
            throw new IllegalArgumentException("coordinate string (" + coordString + ") has a bad number format ("
                + nfe.getMessage() + ")");
        }
        if (coords == null || coords.length != 4) {
            throw new IllegalArgumentException("coordinate string (" + coordString
                + ") does not contain 4 valid coordinates");
        }
    ...
    /**
     * Constructs and initializes a <code>GrappaBox</code> with the coordinates derived from the specified String
     * representation. The String format should be: "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>""
     *
     * @param coordString String representing the coordinates to which to set the newly constructed
     *            <code>GrappaBox</code>
     */
    ...
    /**
     * Returns true if the String format will be "x1,x2,width,height" or false if the format will be "x1,y1,x2,y2". The
     * value is determined at creation time.
     *
