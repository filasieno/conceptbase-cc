...
/**
 * This class extends java.awt.geom.Point2D.Double and provides built-in string-to-Point2D and Point2D-to-string
 * conversions suitable for Grappa.
 *
 * @version $Id: d9008eef97797674905b817b6e2e635ba07194a3 $
...
public class GrappaPoint extends java.awt.geom.Point2D.Double
{
    ...
    /**
     * Constructs and initializes a <code>GrappaPoint</code> with the specified coordinates.
     *
     * @param x,&nbsp;y the coordinates to which to set the newly constructed <code>GrappaPoint</code>
     */
    ...
    /**
     * Constructs and initializes a <code>GrappaPoint</code> with the coordinates derived from the specified String
     * representation. The String format should be: "<I>x-coord</I>,<I>y-coord</I>"
     *
