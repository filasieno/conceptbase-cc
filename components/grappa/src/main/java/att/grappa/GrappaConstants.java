 ...
 *
 * @version $Id: de0d0ce3dac3a3fb44f5d04d70b145dd8229295b $
...
public interface GrappaConstants
{
    ...
    /*
     * edit operations (NOT IMPLEMENTED YET) public final static int EDIT_UNDO = 0; public final static int EDIT_CUT =
     * 1; public final static int EDIT_PASTE = 2; public final static int EDIT_COPY = 3; public final static int
     * EDIT_DELETE = 4; public final static int EDIT_ADD = 5;
     */
    ...
    /**
     * Maximum number of bits needed to represet the Element types. Element type is merged with the element id number (a
     * sequentially assigned number) to ensure a unique identifier (within an invocation of the package).
     */
    ...
    /**
     * Indicator that the element has a record shape. A record shape is of a box shape that contains one or more
     * labelled sub-partitions within it.
     */
