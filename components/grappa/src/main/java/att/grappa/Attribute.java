...
/**
 * A class used for representing attributes associated with the graph elements. An attribute consists of a name-value
 * pair and an element type. Once an attribute is constructed, the name cannot be changed. The element type and the
 * attribute name are used in determining how a string representation of an attribute value is to be converted to an
 * Object and vice versa. The Element class method setUserAttributeType allows users to take advantage of Grappa's
 * built-in converters or to pass a (negative) integer as a conversion indicator to a user-supplied AttributeHandler.
 * <TABLE>
 * <TR>
 * <TD COLSPAN=2>Grappa String Converters</TD>
 * </TR>
 * <TR>
 * <TD>BOX_TYPE</TD>
 ...
 * @version $Id: 07e98533d21f0c5a93d8e4adad1098774bc1e0c2 $
...
public final class Attribute extends java.util.Observable implements AttributeHandler, GrappaConstants
{
     ...
     *
     * @param elemType the element type with which the attribute is or will be associated.
    ...
    public Attribute(int elemType, String attrName, Object attrValue)
    {
        ...
        this.attributeType = attributeType(elemType, attrName);
    ...
    /**
     * Set the value of the attribute. If the value is different than the current value, the Observable changed
     * indicator is set.
     *
    ...
    public final Object setValue(Object attrValue)
    {
        ...
        if (attrValue != null) {
            if (isString) {
                if (changed = (this.stringValue == null || !attrValue.equals(this.stringValue))) {
                    this.stringValue = (String) attrValue;
                    this.value = null;
                }
            } else {
                if (changed = (this.value == null || !attrValue.equals(this.value))) {
                    this.value = copyValue(this.elementType, this.name, attrValue, this.attributeType);
                    this.stringValue = null;
                }
            }
        } else {
    ...
    /**
     * Tests for equality of this attribute's value with the given attribute's value. The attribute names are not
     * compated.
     *
     * @param attr the attribute with which to compare this attribute.
    ...
    /**
     * Use to indicate that this object has changed. This method is a convenience method that calls the corresponding
    ...
    public String convertValue(int type, String name, Object value, int attrtype)
    {
        ...
        switch (attrtype) {
            case BOX_TYPE:
                if (value instanceof GrappaBox) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of GrappaBox");
                }
                break;
            case COLOR_TYPE:
            ...
            case HASHLIST_TYPE:
                if (value instanceof Hashtable) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of Hashtable");
                }
                break;
            case INTEGER_TYPE:
                if (value instanceof Integer) {
            ...
            case LINE_TYPE:
                if (value instanceof GrappaLine) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of GrappaLine");
                }
                break;
            case POINT_TYPE:
                if (value instanceof GrappaPoint) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of GrappaPoint");
                }
                break;
            case SHAPE_TYPE:
                if (value instanceof Integer) {
            ...
            case SIZE_TYPE:
                if (value instanceof GrappaSize) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of GrappaSize");
                }
                break;
            case STRING_TYPE:
            ...
            case STYLE_TYPE:
                if (value instanceof GrappaStyle) {
                    ...
                    throw new IllegalArgumentException("value of attribute \"" + name
                        + "\" is not an instance of GrappaStyle");
                }
                break;
            default:
                if (Attribute.specialHandler != null) {
                    ...
                    throw new RuntimeException(Element.typeString(type, true) + " attribute (" + name
        ...
        if (stringValue == null && value != null) {
            if (value instanceof String) {
                ...
                throw new RuntimeException("AttributeHandler needed to perform conversion of attribute \"" + name
            ...
            switch (attrtype) {
                ...
                case DOUBLE_TYPE:
                    try {
                        ...
                        throw new IllegalArgumentException("bad number format (" + stringValue + ") for attribute \""
                            + name + "\"");
                    }
                    break;
                case FONTSTYLE_TYPE:
                ...
                case INTEGER_TYPE:
                    try {
                        ...
                        throw new IllegalArgumentException("bad integer format (" + stringValue + ") for attribute \""
                            + name + "\"");
                    }
                    break;
                case LINE_TYPE:
                ...
                case POINT_TYPE:
                    ...
                    break;
                case SHAPE_TYPE:
                    if ((value = Grappa.keyToShape.get(stringValue)) == null) {
                        Attribute attr;
                        if ((attr = Graph.getGlobalAttribute(GrappaConstants.NODE, "shape")) == null
                            || (value = Grappa.keyToShape.get(attr.getValue())) == null) {
                            throw new InternalError("could not provide default when unkown shape (" + stringValue
    ...
    public Object copyValue(int type, String name, Object value, int attrtype)
    {
        ...
        if (copy_value == null && value != null) {
            if (value instanceof String) {
                ...
                throw new RuntimeException("AttributeHandler needed to perform copy of attribute \"" + name
                    + "\", please supply one via Attribute.setAttributeHandler()");
            }
        }
    ...
    public static int attributeType(int elemType, String attrName)
    {
        ...
        switch (elemType) {
            ...
            default:
                ...
                throw new IllegalArgumentException("type of attribute \"" + attrName
