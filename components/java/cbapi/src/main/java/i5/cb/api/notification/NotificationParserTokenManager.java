/* NotificationParserTokenManager.java */
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public NotificationParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public NotificationParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
