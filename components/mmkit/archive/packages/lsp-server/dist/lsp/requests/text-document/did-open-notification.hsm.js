...
exports.DidOpenCompleted = exports.DidOpenRunning = exports.DidOpenReceived = exports.DidOpenTop = void 0;
exports.spawnDidOpenNotification = spawnDidOpenNotification;
...
class DidOpenTop extends ihsm.TopState {
}
exports.DidOpenTop = DidOpenTop;
class DidOpenReceived extends DidOpenTop {
    onEntry() {
        this.postNow("start");
    }
    start() {
...
exports.DidOpenReceived = DidOpenReceived;
class DidOpenRunning extends DidOpenTop {
    onEntry() {
        this.postNow("run");
    }
    async run() {
        ...
        }, (s) => this.transition(s), DidOpenCompleted);
    }
}
exports.DidOpenRunning = DidOpenRunning;
class DidOpenCompleted extends DidOpenTop {
    onEntry() {
        this.ctx.server.registry.remove(this.ctx.actorId);
    }
}
exports.DidOpenCompleted = DidOpenCompleted;
...
function spawnDidOpenNotification(server, document) {
    const notificationId = server.registry.allocateId(METHOD);
    (0, notification_lifecycle_helpers_1.spawnNotificationHsm)(server, lsp_actor_type_ids_1.LSP_ACTOR_TYPE_IDS.textDocumentDidOpen, METHOD, notificationId, DidOpenTop, { document });
}
