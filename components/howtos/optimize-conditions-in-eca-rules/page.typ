...
```bash
nix build .#checks.x86_64-linux.optimize-conditions-in-eca-rules
```
...
# in the condition.
# This version: classical definition of petri nets with an ECArule
# Start: CBshell -f PN-1.cbs
#
...
# Test versions of an ECArule with different predicate order
# in the condition.
# This version: change the predicate order (less efficient than PN-2.cbs)
# Start: CBshell -f PN-2.cbs
#
...
```text
=== HOW-TO: optimize-conditions-in-eca-rules (asset validation + smoke) ===
