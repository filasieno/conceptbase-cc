...
# The restart delay is set to 2 seconds to mitigate denial of service

(cbserver -port 5001 -r 2 -a $USER -g public -u nonpersistent -t minimal &>> log5001.log) &
(cbserver -port 5002 -r 2 -a $USER -g public -u nonpersistent -t minimal &>> log5002.log) &
