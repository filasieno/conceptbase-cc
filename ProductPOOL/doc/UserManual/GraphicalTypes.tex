...
\section{TelosPalette: A more modern graphical palette for ConceptBase}
\label{telospalette}
...
The shape "Rect" is a shortcut for the shape string "i5.cb.graph.cbeditor.CBIndividual". CBGraph 
