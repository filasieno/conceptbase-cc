...
\item[Show Link Options:] Allows to specify a category to be used for the toolbar button
"Show links between marked objects". By default, the category is set to "Proposition", i.e.
all links are displayed. You can set the category to "Attribute", if you only want to show links that are attributes
...
The option "Show Link Options" in the menu bar allows to constrain the link type, e.g. "InstanceOf" for
...
\item[ShowLinkCategory:] Allows to limit the type of links expanded when using the tool bar button "Show links between marked objects").
\end{description}
\end{itemize}
