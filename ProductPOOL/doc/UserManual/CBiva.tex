...
as bitmap (e.g. PNG) and vector graphics (SVG) file. The PNG file format is the default.
For technical reasons, the image saving has
...
By default, the whole diagram i.e. the rectangle containing all nodes and edges)
is exported. You can also select the option to export the visible part of the 
diagram canvas.
