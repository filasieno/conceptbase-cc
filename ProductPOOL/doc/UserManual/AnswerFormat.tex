...
Examples for answer formats are available from the GitLab,
...
Examples are available from the GitLab, see \url{https://gitlab.com/mjeu/conceptbasecc/-/tree/master/AdminPOOL/ConceptBase_HOW-TO/Export%20models%20as%20Graphviz%20specifications}.
...
it is false.
An example for conditional expressions is provided in the GitLab, see
